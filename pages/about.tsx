...
export default function IndexPage() {
  return (
    <DefaultLayout>
      <section
        className="flex flex-col gap-4 py-8 md:py-10 relative w-3/4"
        style={{ left: "18%" }}
      >
        <div className="max-w-lg">
          <h1 className={title({ color: "violet" })}>WriteSparkle</h1>
        </div>
        <div>
        ...
        <div>
          <div className="flex">
            ...
            <Link
              ...
              href="https://codezhangborui.com"
            >
              <p className="text-primary">CodeZhangBorui,&nbsp;</p>
            </Link>
            <Link
              isExternal
              className="flex items-center gap-1 text-current"
              href="https://lampese.com/about/"
            >
              <p className="text-primary">Lampese</p>
            </Link>
            <span className="text-default-600">, yzh-yzxgg and&nbsp;</span>
            <Link
              isExternal
              className="flex items-center gap-1 text-current"
              href="https://github.com/CodeZhangBorui/WriteSparkle/graphs/contributors"
            >
              <p className="text-primary">All contributors</p>
            </Link>
          </div>
          <p className="text-default-600">
            ...
            <Link
              ...
              href="https://oneapi.codezhangborui.com"
            >
              Hello API
            </Link>{" "}
            提供支持。
